      ...
      <div className="st_ops">
        <div className="st_op_c">
          ...
          <div className="st_ln_co">
            ...
            />
            <Image
              src="https://nxtwave.imgix.net/ccbp-website/intensive/express-js.png"
              className="st_e_lim"
              alt=""
              height={100}
              width={104}
            ...
            />
            <Image
              src="https://nxtwave.imgix.net/ccbp-website/intensive/react-js.png"
              className="st_e_lim"
              alt=""
              height={100}
              width={100}
            ...
            />
            <Image
              src="https://nxtwave.imgix.net/ccbp-website/intensive/node-js.png"
              className="st_e_lim"
              alt=""
              height={100}
              width={100}
          ...
          <a
            ...
            href="#"
            target="_blank"
            className="st_v_c w-inline-block"
          >
            <div>View Curriculum</div>
            <div className="st-c_ar" />
          </a>
        </div>
        <div className="st_op_c">
          <div
          ...
          <div className="st_ln_co">
            ...
            />
            <Image
              src="https://nxtwave.imgix.net/ccbp-website/intensive/java.png"
              className="st_e_lim"
              alt=""
              height={80}
              width={100}
            ...
            />
            <Image
              src="https://nxtwave.imgix.net/ccbp-website/intensive/spring-boot.png"
              className="spring"
              alt=""
              height={100}
              width={104}
