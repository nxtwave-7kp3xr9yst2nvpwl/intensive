      ...
      <div className="st_ln_co">
        <div className="st_eac_l">
          <Image
            ...
            src="https://nxtwave.imgix.net/ccbp-website/nxtwave-intensive-2.0/html.png"
            alt=""
            loading="lazy"
            height={64}
            width={64}
        ...
        <div className="st_eac_l">
          <Image
            className="st_eac_l_im"
            src="https://nxtwave.imgix.net/ccbp-website/nxtwave-intensive-2.0/css.png"
            alt=""
            loading="lazy"
            height={64}
            width={64}
        ...
        <div className="st_eac_l">
          <Image
            className="st_eac_l_im"
            src="https://nxtwave.imgix.net/ccbp-website/nxtwave-intensive-2.0/python.png"
            alt=""
            loading="lazy"
            height={57}
            width={56}
        ...
        <div className="st_eac_l">
          <Image
            className="st_eac_l_im"
            src="https://nxtwave.imgix.net/ccbp-website/nxtwave-intensive-2.0/sql.png"
            alt=""
            loading="lazy"
            height={57}
            width={56}
