...
const addOnData = [
  {
    ...
    img_link:
      "https://nxtwave.imgix.net/ccbp-website/nxtwave-intensive-2.0/Aptitude.png",
  },
  {
    add_ons: "Soft Skills Training",
    img_link:
      "https://nxtwave.imgix.net/ccbp-website/nxtwave-intensive-2.0/soft-skills-coaching.png",
  },
  {
    add_ons: "Resume Preparation",
    img_link:
      "https://nxtwave.imgix.net/ccbp-website/nxtwave-intensive-2.0/resume-preparation.png",
  },
  {
    add_ons: "AI-Powered Mock Interviews",
    img_link:
      "https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/intensive/3.0-upgrades-mock-interviews.png",
  },
  {
    add_ons: "Mock Interviews by Tech and HR Panels",
    img_link:
      "https://nxtwave.imgix.net/ccbp-website/nxtwave-intensive-2.0/mock-interviews.png",
  },
  {
    add_ons: "Scheduling Interviews",
    img_link:
      "https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/nxtwave-intensive-2.0/scheduling.png",
  },
  {
    add_ons: "Access to 300+ Senior Interview Experiences",
    img_link:
      "https://nxtwave.imgix.net/ccbp-website/nxtwave-intensive-2.0/access-interview-experiences.png",
  },
  {
    add_ons: "Access to Placement Portal",
    img_link:
      "https://nxtwave.imgix.net/ccbp-website/nxtwave-intensive-2.0/access-placement-corner.png",
  },
  {
    add_ons: "Mega Offline Placement Drives",
    img_link:
      "https://nxtwave.imgix.net/ccbp-website/intensive/3.0-upgrades-offline-drives.png",
  },
  {
    add_ons: "Negotiation with companies for higher salaries",
    img_link:
      "https://nxtwave.imgix.net/ccbp-website/nxtwave-intensive-2.0/negotiation-with-companies.png",
  },
];
